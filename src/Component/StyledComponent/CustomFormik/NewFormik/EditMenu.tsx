...
import { CustomBox, Flex } from "../../CustomBox/CustomBox";
                    ...
                    <Flex>
                        <Form className={style.content}>
                            ...
                            <Input
                                ...
                                error={
                                    errors.nama && touched.nama ? true : false
                                }
                            />
                            <Input
                                name={Data[1].value}
                                ...
                                error={
                                    errors.harga && touched.harga ? true : false
                                }
                            />
                            <Input
                                name={Data[2].value}
                                ...
                                error={
                                    errors.brand && touched.brand ? true : false
                                }
                            />
                            <Input
                                name={Data[3].value}
